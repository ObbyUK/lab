  ...
  render () {
    return (
      <div className="landing-page">
        ...
        >
          <Menu mode="normal">
            <a href="#about-us" className="landing-page__menu-link">About us</a>
            <a href="#reviews" className="landing-page__menu-link">Reviews</a>
            <a href="#what-you-need" className="landing-page__menu-link">What you need</a>
            <a href="#schedule" className="landing-page__menu-link">Schedule</a>
            <a href="#teachers" className="landing-page__menu-link">Teachers</a>
            <a href="#venues" className="landing-page__menu-link">Venues</a>
            <a href="#faq" className="landing-page__menu-link">FAQ's</a>
            <a href="#classes" className="landing-page__menu-button">
              <PrimaryButton 
                color="ebony-clay"
                text="Book a course"
                onClick={console.log}
